...
class $ProductsTable extends Products
  ...
  VerificationContext validateIntegrity(
    Insertable<ProductLocal> instance, {
...
class ProductLocal extends DataClass implements Insertable<ProductLocal> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, title, price, description, category, thumbnail);
  @override
...
class $$ProductsTableTableManager
    extends
        RootTableManager<
          ...
          (
            ProductLocal,
            BaseReferences<_$AppDatabase, $ProductsTable, ProductLocal>,
          ),
          ProductLocal,
